...
public class VerifyConfirmationMessage {
    ...
    public static void main(String[] args) {
        ...
        enter any email
        verify that email is displayed in the input box // we need if statements here****
        click on Retrieve password
        verify that confirmation message says 'Your e-mail's been sent!'// we need if statements here****
        */
